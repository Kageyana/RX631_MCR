...
signed char check_slope( void )
{
	...
	if ( PichAngleIMU >= SLOPEUPPERLINE_IMU ) ret = 1;
	if ( PichAngleIMU <= SLOPELOWERLINE_IMU ) ret = -1;
...
void servoControl2( void )
{
	...
	Dif = Dev - AngleBefore2;		// dゲイン1/1000倍

	if ( Int > 10000 ) Int = 1280;
	else if ( Int < -10000 ) Int = -1280;
